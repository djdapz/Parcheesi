package tests.parcheesi.game.moves;
...
public class EnterPieceTest {
    ...
    public void canBopOnExitFromSafeSpace() throws Exception {
        PlayerInterface p1 = players.get(0);
        PlayerInterface p2 = players.get(1);
        ...
        assertTrue(rc.makeSurePawnIsOnlyInOneSpot(board, p1Pawn));
        assertTrue(rc.makeSurePawnIsOnlyInOneSpot(board, p2Pawn));
    ...
    public void cannotEnterOnBlockade() throws Exception {
        ...
        assertTrue(rc.makeSurePawnIsOnlyInOneSpot(board, p2Pawn1));
        assertTrue(rc.makeSurePawnIsOnlyInOneSpot(board, p2Pawn2));
        assertTrue(rc.makeSurePawnIsOnlyInOneSpot(board, p1Pawn));
