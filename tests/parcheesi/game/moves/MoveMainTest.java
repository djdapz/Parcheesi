...
public class MoveMainTest {
    ...
    public void  boppingWorks() throws Exception{
        ...
        assertTrue(rc.makeSurePawnIsOnlyInOneSpot(board, boppedPawn));
        assertTrue(rc.makeSurePawnIsOnlyInOneSpot(board, bopperPawn));
    }
    ...
    public void  goesToHomeRowAtRightTime() throws Exception{
        ...
        assertTrue(rc.makeSurePawnIsOnlyInOneSpot(board, mainPawn));
    }
