...
public class PawnTest {
    ...
    public void canMoveFailsWithBlockadeInHomeRow() throws Exception {
        ...
        Pawn pawnBlocking1 = players[0].getPawns()[2];
        Pawn pawnBlocking2 = players[0].getPawns()[1];
    ...
    public void canMoveFailsOnMovementIntoHomeRowWithBlockade() throws Exception {
        Pawn pawn = players[0].getPawns()[0];
        Pawn pawnBlocking1 = players[0].getPawns()[1];
        Pawn pawnBlocking2 = players[0].getPawns()[2];
        ...
        mainRing.get(pawn.getHomeEntrance().getId()-1).addOccupant(pawn);
        assertTrue(pawn.canMove(moves, board));
